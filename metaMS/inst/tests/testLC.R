## Script to test the main mstaMS finctions
if (require("testthat", quietly = TRUE) & require("metaMSdata", quietly = TRUE)){
  ...
  warning("cannot run tests --  package testthat and/or package metaMSdata are not available")
}
