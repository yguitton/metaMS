## New version, working for both LC and GC, and reading cdf as well as
## mzxml files

## 1) compare filenames from input file with files in standards dir
## 2) process all input files in parallel
                             ...
                             polarity = NULL)
{
  ...
  if (length(empty.idx)>0) xset.l.small <- xset.l.small[-empty.idx]
